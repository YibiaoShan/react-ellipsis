...
require("./index.css");
var _excluded = ["content", "rows", "expandText", "collapseText", "symbol", "lineHeight"];
...
var Ellipsis = function Ellipsis(props) {
  ...
  var maxHeight = Math.floor(lineHeight * (Number(rows) + 0.5));
  ...
  // 计算省略具体位置
  var tailor = (0, _react.useCallback)(function (left, right) {
  ...
  // 计算省略号的位置
  var calcEllipse = (0, _react.useCallback)(function () {
    if (container.current.offsetHeight <= maxHeight) {
      setExceeded(false);
    } else {
      setExceeded(true);
      var end = content.length;
      var ellipsised = tailor(0, end);
      ellipsis.current = ellipsised;
    }
  }, [content.length, maxHeight, tailor]);

  // 创建虚拟 container，内容为 contant 的内容
  var createContainer = (0, _react.useCallback)(function () {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", _extends({
    ref: root
  }, rest), !exceeded ? content : null, exceeded && !expanded ? /*#__PURE__*/_react["default"].createElement("span", null, ellipsis.current, expandText ? /*#__PURE__*/_react["default"].createElement("span", {
    className: "ellipsis-text",
    onClick: function onClick(e) {
      e.stopPropagation();
      setExpanded(true);
    }
  }, expandText) : null) : null, exceeded && expanded ? /*#__PURE__*/_react["default"].createElement("span", null, content, expandText ? /*#__PURE__*/_react["default"].createElement("span", {
    className: "ellipsis-text",
    onClick: function onClick(e) {
      e.stopPropagation();
      setExpanded(false);
